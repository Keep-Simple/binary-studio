...
import static com.keep.simple.backend.config.SecurityConstants.HEADER_STRING;
import static com.keep.simple.backend.config.SecurityConstants.TOKEN_PREFIX;
